...
import org.tech.kafka.demo1.Producer;
...
public class SimpleConsumerDemo {
    ...
    private static void generateData() {
        Producer producer2 = new Producer(KafkaProperties.TOPIC2, 5);
        producer2.start();
        
        Producer producer3 = new Producer(KafkaProperties.TOPIC3, 5);
        producer3.start();
        try {
            Thread.sleep(1000);
    ...
    public static void main(String[] args) throws Exception {
        ...
        FetchRequest req = new FetchRequestBuilder()
            ...
            .addFetch(KafkaProperties.TOPIC2, 0, 0L, 1000)
            .build();
