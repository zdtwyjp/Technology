package org.tech.java.proxy.station;
...
public class Test {  
    ...
    {  
        ...
        CtClass cc = pool.makeClass("org.tech.java.proxy.station.StationProxy");  
          
        //设置接口  
        CtClass interface1 = pool.get("org.tech.java.proxy.station.TicketService");  
        cc.setInterfaces(new CtClass[]{interface1});  
          
        //设置Field  
        CtField field = CtField.make("private org.tech.java.proxy.station.Station station;", cc);  
          
        cc.addField(field);  
          
        CtClass stationClass = pool.get("org.tech.java.proxy.station.Station");  
